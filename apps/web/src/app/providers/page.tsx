...
function resolveProvidersCsvPath() {
  ...
  throw new Error(
    "providers.csv not found. Expected at /data/sheets/providers.csv in repo root."
  );
}
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-10">
      <header>
        <Card className="bg-surface">
          ...
          <p className="mt-3 text-text-secondary">
            Base consultable de proveedores locales en Argentina (fuente y
            última verificación). Este dataset también se utiliza para análisis
            y BI (Power BI).
          </p>
          ...
          <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="text-sm text-text-secondary">
                También podés recorrer el dataset en una vista visual por ciudad
                y provincia.
              </p>
            </div>
      ...
      <footer className="mt-8 text-xs text-neutral-500">
        Nota: esta lista es informativa. Verificá disponibilidad y condiciones
